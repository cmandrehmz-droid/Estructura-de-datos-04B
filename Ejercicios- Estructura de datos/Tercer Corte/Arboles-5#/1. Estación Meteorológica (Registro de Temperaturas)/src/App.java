/* Una red de sensores ambientales distribuidos en la cordillera registra la temperatura máxima diaria de cada estación. 
Los datos se almacenan en un BST usando la temperatura como clave de ordenamiento, lo que permite consultarlos en orden cronológico de menor a mayor y detectar anomalías rápidamente.
...
Reto: Implementa el método contarSobre(double umbral) que recorra el árbol y retorne la cantidad de nodos cuya temperatura sea estrictamente mayor que el umbral recibido, 
sin modificar la estructura. Aprovecha la propiedad del BST para evitar recorrer subárboles innecesarios: si el nodo actual es ≤ umbral, los menores también lo serán.
 */
