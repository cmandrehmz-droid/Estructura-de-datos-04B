        ...
        do {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    System.out.print("Duración Estimada (minutos): "); String duracion = scanner.nextLine();
                ...
                case 3:
                    ...
                    if (atendida != null) {
                        System.out.println("Atendiendo llamada de " + atendida.nombreCliente + " por motivo: " + atendida.motivoConsulta);
                    } else {
